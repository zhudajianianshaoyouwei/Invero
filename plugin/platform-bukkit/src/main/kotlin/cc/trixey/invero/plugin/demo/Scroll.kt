...
fun showScroll2(player: Player) = chestWindow(player.viewer, 6, "Loop Scroll (horizontally)") {
...
fun showScrollStandard(player: Player) = chestWindow(player.viewer, 6, "Scroll_Standard") {
